...
http://10.6.14.26:8089/
    
bash <(curl -s -S -L http://10.6.14.26:8089/up) $filepath $dirpath
...
```azure
curl -F file=@/Users/uuxia/Downloads/list.json -F token=het002402 localhost:8000/uuxiafile

bash <(curl -s -S -L http://127.0.0.1:8000/up) $filepath $dirpath
